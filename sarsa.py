...
def train_agent_sarsa(env:gym.Env, q_table):
    ...
    while n_games <= GAMES_LIMIT:
        ...
        while not done:
            ...
            # We calculate the new q value with Q(s,a) = Q(s,a) + α * [r + γ * Q(s',a') - Q(s,a)]
            new_q_value = q_table[state][action] + LR * (reward + GAMMA * q_table[new_state][new_action] - q_table[state][action])
